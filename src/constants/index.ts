...
const experiences: TExperience[] = [
  {
    ...
    points: [
      'Developing IIoT Industry 4.0 SaaS platforms using Claude Code for complex multi-file architectures & agentic workflows, building on prior AI-assisted development, full-stack, & project management experience',
      'Documenting Claude Code best practices including context management strategies, parallel development, prompt engineering techniques, & workflow optimizations for team adoption',
      'Building RAG-based AI models serving as subject matter experts, creating comprehensive documentation for implementation patterns',
      'Developing internal training materials & guides for effective AI-assisted development',
  ...
  },
  {
    ...
    points: [
      'Trained AI chatbots to write better code; upskilled on AI-assisted coding workflows & prompt engineering; served as AI bootcamp tutor',
      ...
      'Successfully helped a renewable energy equipment supplier secure WA state grant funding & strategic partnerships with major universities; collaborated with leaders on technical vision',
      ...
      'Created technical documentation, presentations, and video tutorials for internal and stakeholder audiences (Media Studies background applied to technical education)',
    ],
  },
  {
